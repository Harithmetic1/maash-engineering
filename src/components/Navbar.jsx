...
function Navbar() {
  ...
  return (
    ...
    <nav className={`p-3 flex flex-col sm:hidden text-sm lg:text-base xl:px-20 justify-evenly items-center w-full`}>
        ...
        <div className={`nav-links z-0 ${showSearch ? "reveal-nav" : "hide-nav"} w-full flex flex-col justify-center gap-4 items-center`}>
        ...
        <div className={`search-bar z-0 ${showNav ? "reveal-search" : "hide-search"} w-full flex flex-col justify-center gap-4 items-center`}>
            <div className="search-bar-input w-full">
                <input type="text" placeholder='Search for equipments' className='w-full h-full p-3 rounded'/>
            </div>
